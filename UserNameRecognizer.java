	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1:
				...
				//  2: a minus signs, underscore, period that transitions to state 3 
				...
				// minus signs, underscore, period -> State 3
				else if (currentChar == '-' || currentChar == '_' || currentChar == '.') {	// Check for minus signs, underscore, period
					nextState = 3;
			...
			case 2: 
				...
				//	1: a A-Z, a-z, 0-9 that transitions back to state 2
				//  2: a minus signs, underscore, period that transitions to state 3 
			...
			case 3: 
				// State 3 deals with a A-Z, a-z, 0-9 that transitions to state 2
		...
		case 0:
			...
			userNameRecognizerErrorMessage += "A UserName must start with A-Z, a-z and must have at least 4 characters.\n";
			return userNameRecognizerErrorMessage;
		
		case 1:
			// State 1 is not a final state, so we can return a very specific error message
			userNameRecognizerErrorMessage += "A UserName must start with A-Z, a-z, minus signs (-), underscore (_), period (.) and must have at least 4 characters.\n";
			return userNameRecognizerErrorMessage;
		...
		case 2:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += "A UserName must have at least 4 characters and may only contain the characters "
						+ "A-Z, a-z, 0-9, minus signs (-), underscore (_), period (.).\n";
				return userNameRecognizerErrorMessage;
			}
				...
				userNameRecognizerErrorMessage += 
					"A UserName character may only contain the characters A-Z, a-z, 0-9, minus signs (-), underscore (_), period (.).\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
		...
		case 3:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a minus signs (-), underscore (_), period (.) must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
